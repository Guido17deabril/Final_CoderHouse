...
namespace Final_CoderHouse.Repository
{
    public class ADO_ProductoVendido
    {
        ...
        public static List<ProductoVendido> TraerProductosVendidosXIdUsuario(long idUsuario)
        {
        ...
        public static List<ProductoVendido> TraerProductosVendidosXIdVenta(long idVenta)
        {
        ...
        public static bool EliminarProductoVendidoXIdVenta(long idVenta)
        {
            bool resultado = false;
            int rowsAffected = 0;
